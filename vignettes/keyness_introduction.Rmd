...
1. The **quanteda** package has it's own native keyness function as part of  [**quanteda.textstats**](https://CRAN.R-project.org/package=quanteda.textstats): **textstat_keyness( )**.
...
1. **DP_Tar**: the **deviation of proportions** (a dispersion measure) in the target corpus
